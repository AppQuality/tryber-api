...
services:
  app:
    ...
    environment:
      ...
      PAYMENT_INVOICE_RECAP_EMAIL_VAT: '${PAYMENT_INVOICE_RECAP_EMAIL_VAT}'
      PAYMENT_INVOICE_RECAP_EMAIL_WITHOLDING_EXTRA: "${PAYMENT_INVOICE_RECAP_EMAIL_WITHOLDING_EXTRA}"
      PAYMENT_INVOICE_RECAP_EMAIL_COMPANY: '${PAYMENT_INVOICE_RECAP_EMAIL_COMPANY}'
      ...
      TESTER_LEADER_CPV2_NAME: '${TESTER_LEADER_CPV2_NAME}'
